    ...
    for path in sorted(candidates):
        ...
        if is_image:
            asset = {
                ...
                "generation_summary": "从已成功落盘但未登记的本地 OpenAI 兼容图片文件恢复。",
                "provider": "openai_compatible_local",
                "license": "AI-generated by the configured local image service",
            }
...
def generate_lesson_scene_image(project_dir: Path, scene_id: str) -> dict[str, Any]:
    ...
    _update_studio_state(
        ...
        message=f"{IMAGE_MODEL} 正在生成 {scene_id} 首帧。",
    )
    ...
    asset = {
        ...
        "format": "png",
        "subtype": "generated-first-frame",
        "generation_summary": "用户单次点击触发的本地 OpenAI 兼容文生图；固定模型、中等质量与种子，无模型回退。",
        "provider": "openai_compatible_local",
        "license": "AI-generated by the configured local image service",
    }
